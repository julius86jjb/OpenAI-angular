...
import { ChangeDetectionStrategy, Component, Input, EventEmitter, Output, AfterViewInit, ViewChild, ElementRef, signal, WritableSignal } from '@angular/core';
...
export class GptMessageEditableImageComponent implements AfterViewInit {
  ...
  @Input({ required: true }) imageInfo!: { url: string, alt: string, error: boolean, errorMessage?: string };
